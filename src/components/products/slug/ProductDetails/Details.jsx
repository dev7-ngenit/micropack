...
export default function Details({ data, activeVariant, setActiveVariant }) {
  ...
  return (
    <div className="px-3">
      ...
      <p className="mt-5 text-3xl">${images[activeVariant.index]?.price}</p>
          ...
          {images.map((img, index) => (
            <button
              ...
              className={cn(
                ...
                activeVariant.index === index && "border-blue-500 bg-gray-200",
              )}
              onClick={() =>
                setActiveVariant({
                  color: img.color,
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xl font-semibold">{img?.color_name}</span>
